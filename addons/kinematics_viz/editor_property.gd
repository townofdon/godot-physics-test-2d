...
func _init() -> void:
	...
	label_kine.text = "Kinematic Curve"
	label_drag.text = "Drag Response"
	label_kine.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
	label_drag.horizontal_alignment = HORIZONTAL_ALIGNMENT_CENTER
	add_child(container)
